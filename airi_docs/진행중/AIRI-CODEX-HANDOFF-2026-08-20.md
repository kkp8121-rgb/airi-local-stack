...
> **2026-08-22 대체됨:** 이 문서는 당시 스냅샷 보존용이다. 뒤쪽의 “레퍼런스 7건”은
> 초기 상태이며, 현행 기준은 **event reference 30건·11명 + 별도 continuity arc 7건**이다.
> 최신 실행 기준은 `AIRI-CODEX-HANDOFF-2026-08-21.md`와 로드맵을 따른다. 2026-08-22
> 사용자 `/goal`로 goal은 `active`지만 E2 전 P0 전원 종료 내구성 게이트가 추가됐다.
