---
schema_version: 1
updated_at_kst: "2026-08-26 19:10:00 +09:00"
checkpoint_id: "20260826-192000-m7-s6-run07-receipt"
matrix_note: "S6 executed: run 07-r1..r3 (06b config + --replay-transcript, 618 STT segments, 81/99 turns with speech) all exit 0 and no collapse on either metric (top response 8/3/3, distinct 77/93/96) — first such arm. First context-grounded answers (server, tracker mounting, Ring Fit). M7-10 guard fired live on the rumour turn (leading line replaced; continuation still half-confirms — limitation recorded). Claude reference rating of 07-r2: 3-axis 2.37 (+0.62), filler 40%, critical 0. Upstream v0.12.0-beta.1 checked - not relevant. Waiting: run 07-r2 human rating, push approval. No services running"
...
active_phase: "m7-await-run07-r2-human-rating"
git_head: "5a5e22583281beb9919efeb88ca0ebdf02a227a1"
