---
schema_version: 1
updated_at_kst: "2026-08-26 12:35:00 +09:00"
checkpoint_id: "20260826-123500-m6-replay-run-04-receipt-preliminary-rating"
matrix_note: "M6: real-chat replay run 04 complete (99 answered turns + 1 screened, service_error 0) on the operational config; Claude preliminary rating (reference only) broadcast 1.89 / context 1.85 / response 1.99 / style 4.03 / factuality 3.99, filler 44%, critical 3%; human rating sheet ready outside the repo. Local HEAD f408eb7 is ahead of origin/main 39c29bf (6dd8b22 replay/import tooling, f408eb7 screened-input fix, docs batch pending); push not approved. Waiting on user: final human rating + next candidate choice"
active_trainer_note: "GPU 학습 없음. replay run 04 종료, 스택 stop, owned listener 0"
goal_status: "active"
...
active_phase: "m6-await-human-rating-and-next-candidate"
git_head: "f408eb77f6931ee3261817550bf8a58e604c2e3c"
worktree_state: "local main f408eb7 ahead of origin/main 39c29bf by 2 (push not approved); dirty = docs receipt batch only; single worktree; AIRI PID 0, owned listeners 0"
...
| 현재 행동 | run 04 완료·1차 참고 채점 완료. 사용자 최종 채점(rating-sheet.html)과 첫 개선 후보 결정을 기다린다. 실행 중 프로세스 0. |
