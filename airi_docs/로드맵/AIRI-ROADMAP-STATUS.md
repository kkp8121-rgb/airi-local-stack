...
- [ ] 결정 1 — 관계 축: 사용자가 방송에 출연하는가 (C1 확정·방송 포맷 차단)
- [ ] 결정 2 — 방송 중 클라우드 LLM 승인 (B2 송출 구성 차단, VRAM 판정상 사실상 필수)
- [ ] 결정 3 — 캐릭터 확정: 이름·시그니처 인사·팬덤명 + T-05 한국어 음성 화자
- [ ] 결정 4 — 첫 방송 목표 시점
- [ ] 결정 5 — 지연 목표 §12 공식 개정 (첫 반응 ≤1.5s / 본답변 ≤2.5s)
...
- [~] 본답변 ≤2.5s — 텍스트 경로 P50 1,963ms 달성(`완료/AIRI-ELECTRON-TEXT-TTS-MEASUREMENT-2026-08-12.md`), 실제 마이크 음성 전체 체인은 미실측
