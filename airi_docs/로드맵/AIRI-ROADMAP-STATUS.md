...
- [ ] **P3-T3 전/후 게이트** — 시뮬 하네스 그대로. **캘리브레이션 완료
  ...
  (`완료/AIRI-SPAN-CONTRACT-AND-VARIANCE-2026-08-19.md`). 미통과 어댑터 폐기
...
| G2 장기 기억 | **P1 공급원** | Stage A 스팬 계약 실측 완료(2026-08-19 — 날조 차단 실증, 판단 축은 미돌파: 추출 판단도 학습 후보 + 코덱스 8B+span 1회 실측 권고), MEM-04 락 경합 실측, I2=P1-2 |
