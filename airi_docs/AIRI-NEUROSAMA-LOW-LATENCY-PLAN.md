...
> **2026-08-06 런타임 주의:** 이 문서는 목표·후보를 포함한 계획서다. 현재 구현 여부는 `AIRI-RUNTIME-TECH-AUDIT-2026-08-06.md`를 기준으로 판단한다. 실제 이 PC의 CPU는 Ryzen 5 5600X(6코어 12스레드)이며, RAG·클라우드 LLM·스트리밍 STT·true barge-in·점진적 TTS 재생은 아직 계획 단계다.
